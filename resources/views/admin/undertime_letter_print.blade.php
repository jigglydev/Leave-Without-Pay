...
<head>
    ...
    <title>Undertime Letter — {{ $employee->full_name ?: $employee->name }}</title>
...
<body>
    ...
    <div class="toolbar">
        ...
        <span style="color:#94a3b8; font-size:13px; font-family:Inter,sans-serif;">
            Undertime Letter — {{ $employee->full_name ?: $employee->name }}
        </span>
    ...
    <div class="print-area">
        ...
        <div class="salutation" style="margin-bottom: 20px;">
            Dear {{ $prefix }} {{ strtoupper($last ?: $pdfName) }},
        </div>

        {{-- ══ BODY ══ --}}
        <div class="body-para" style="text-indent: 50px; text-align: justify; margin-bottom: 20px;">
            Records indicate that you incurred <span>{{ $undertimeCount }}</span> times undertime during the month of <span>{{ $month }} {{ $year }}</span>. Please be reminded that CSC Memorandum Circular No. 16, series of 2010 states that such repeated undertime, regardless of the number of minutes or hours, for at least two (2) consecutive months in a semester is considered <strong>Simple Misconduct and/or Conduct Prejudicial to the Best Interest of the Service.</strong>
        </div>

        <div class="body-para" style="text-indent: 50px; text-align: justify; margin-bottom: 20px;">
            Be reminded further that under Rule X, Section 63 (A.2.a), (B.9) of the 2025 Revised Rules on Administrative Cases in the Civil Service, the corresponding penalty for the above stated offense is as follows:
        </div>

        <table style="margin: 0 auto 20px auto; font-style: italic; font-size: 11pt; width: 75%; border-collapse: collapse;">
            <tr>
                <td style="padding: 2px 10px; width: 40px;">a.</td>
                <td style="padding: 2px 10px; width: 140px;">1st Offense</td>
                <td style="padding: 2px 10px; width: 20px;">-</td>
                <td style="padding: 2px 10px;">Suspension of one (1) month up to 6 months or 1 year</td>
            </tr>
            <tr>
        ...
        <div class="body-para" style="text-indent: 50px; text-align: justify; margin-bottom: 40px;">
            Relative hereto, you are hereby advised to comply with the prescribed office hours and avoid any further instances of undertime. We trust that you will take this reminder seriously and demonstrate the necessary commitment to your duties and responsibilities.
        </div>
