...
@section('title', 'Tardy Letter Generation')
@section('content')

<div class="mb-6">
    <h1 class="text-2xl font-bold text-slate-800 dark:text-white">Generate Tardy Letter</h1>
    <p class="text-sm text-slate-500 dark:text-slate-400 mt-0.5">Generate a formal notice letter for employee tardiness records.</p>
</div>

<div class="max-w-4xl"
     x-data="tardyLetterForm({{ $allUsers->toJson() }})">
    ...
    <form method="POST" action="{{ route('admin.undertime-tardy.tardy-letter.generate') }}">
        @csrf
        ...
        <div class="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm mb-5">
            ...
            <div class="p-6 grid grid-cols-1 md:grid-cols-3 gap-5">
                ...
                <div>
                    <label class="block text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-1.5">
                        No. of Tardiness Occurrences <span class="text-red-400">*</span>
                    </label>
                    <input type="text" name="tardiness_count" required
                    ...
                    <p class="text-xs text-slate-400 mt-1">Appears as: "You have incurred ___ times of tardiness."</p>
                </div>
...
<script>
function tardyLetterForm(employees) {
    return {
        employees,
        query: '',
        filtered: [],
