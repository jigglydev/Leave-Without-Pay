...
<div class="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm p-8 max-w-2xl">

    {{-- Avatar + Name --}}
    <div class="flex items-center gap-4 mb-8">
        <div class="w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center text-white text-2xl font-bold shadow-lg shadow-blue-500/30">
        ...
        <div class="space-y-5">
            ...
            <div class="pb-1">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    {{-- Last Name --}}
                    <div>
                        <label class="block text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-1.5">Last Name <span class="text-red-400">*</span></label>
                    ...
                    {{-- Given Name --}}
                    <div>
                        <label class="block text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-1.5">Given Name <span class="text-red-400">*</span></label>
                    ...
                    {{-- Middle Name --}}
                    <div>
                        <label class="block text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-1.5">Middle Name <span class="text-slate-300 dark:text-slate-600 font-normal">(optional)</span></label>
                    ...
                    {{-- Suffix --}}
                    <div>
                        <label class="block text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-1.5">Suffix <span class="text-slate-300 dark:text-slate-600 font-normal">(optional)</span></label>
            ...
            {{-- ── Employee Number ───────────────────────────── --}}
            <div>
                <label class="block text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-1.5">Employee Number <span class="text-slate-300 dark:text-slate-600 font-normal">(optional)</span></label>
            ...
            <div x-data="searchableSelect('office', {{ json_encode($officeNames) }}, {{ json_encode(old('office', $user->office ?? '')) }})" class="relative" @click.outside="close()">
            ...
            <div x-data="searchableSelect('position', {{ json_encode($positionNames) }}, {{ json_encode(old('position', $user->position ?? '')) }})" class="relative" @click.outside="close()">
            ...
            {{-- Joined at --}}
            <div class="flex items-center gap-3 p-3 rounded-xl bg-slate-50 dark:bg-slate-700/50 text-sm text-slate-500 dark:text-slate-400">
                <svg class="w-4 h-4 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
